...
export class AppLandingpageComponent {
  ...
  testimonials: testimonials[] = [
    ...
    },
    {
      ...
      subtext: 'Features avaibility',
      para: 'I am using RIPSWARE services, and they are feature rich, easy to integrate and save a ton of time. The Support Team is great.'
    },
  ];
  ...
  features: features[] = [
    {
      ...
      subtext:
        'RIPSWARE comes with 6 pre-defined theme colors.',
    },
    {
      id: 2,
      icon: 'shield-lock',
    ...
    },
    {
      ...
      subtext:
        'The RIPSWARE platform includes nearly 50 UI components.',
    },
    {
      id: 5,
      icon: 'tag',
    ...
    },
    {
      ...
      subtext:
        'The RIPSWARE platform includes a wide variety of icon fonts.',
    },
    {
      id: 7,
