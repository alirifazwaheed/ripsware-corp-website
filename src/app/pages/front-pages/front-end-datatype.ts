  ...
  export const records = [
    {
      id:1,
      title:'2019',
      subtitle:'When RIPSWARE was founded'
    },
     {
      id:2,
      title:'300k+',
      subtitle:'Customers trust RIPSWARE'
    },
     {
      id:3,
      title:'25k+',
      subtitle:'Solutions delivered by RIPSWARE'
    }
  ];
 ...
 export const followercardsThird: followercards[] = [
  ...
  export const brandLogos = [
    ...
    },
    {
      ...
      name: 'Jikes Sam',
      subtext:
        'I am using RIPSWARE services, and they are feature rich, easy to integrate and save a ton of time. The Support Team is great.',
    },
     {
      id: 4,
      imgSrc: '/assets/images/profile/user-1.jpg',
